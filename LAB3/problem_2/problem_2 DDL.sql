...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 08, 2022 at 05:24 PM
...
(26, 1, '1976-03-29 20:31:19', '1976-07-28 22:33:23', '2005-05-24 07:43:52'),
...
ALTER TABLE `borrowing_book`
  ADD PRIMARY KEY (`member_id`,`book_id`,`borrow_date`),
...
ALTER TABLE `borrowing_book`
  ...
  ADD CONSTRAINT `borrowing_book_ibfk_3` FOREIGN KEY (`member_id`) REFERENCES `member` (`member_id`);
COMMIT;
